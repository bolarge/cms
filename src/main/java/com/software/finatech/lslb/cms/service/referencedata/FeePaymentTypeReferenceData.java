...
public class FeePaymentTypeReferenceData {
    public static void load(MongoRepositoryReactiveImpl mongoRepositoryReactive) {
        FeePaymentType feePaymentType1 = (FeePaymentType) mongoRepositoryReactive.findById("1", FeePaymentType.class).block();
        if (feePaymentType1 == null) {
            feePaymentType1 = new FeePaymentType();
            feePaymentType1.setId("1");
        }
        feePaymentType1.setName("Application Fees");

        FeePaymentType feePaymentType2 = (FeePaymentType) mongoRepositoryReactive.findById("2", FeePaymentType.class).block();
        if (feePaymentType2 == null) {
            feePaymentType2 = new FeePaymentType();
            feePaymentType2.setId("2");
        }
        feePaymentType2.setName("Licensing Fees");

        FeePaymentType feePaymentType3 = (FeePaymentType) mongoRepositoryReactive.findById("3", FeePaymentType.class).block();
        if (feePaymentType3 == null) {
            feePaymentType3 = new FeePaymentType();
            feePaymentType3.setId("3");
        }
